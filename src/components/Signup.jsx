...
const hanldeLoginClick=async ()=>{
  ...
  <input type="text" className="grow" value={email} onChange={handleEmailChange} placeholder="Email" />
</label>
...
<label className="  mt-2 input input-bordered flex items-center gap-2">
  ...
  <input type="password" className="grow" placeholder="Password" value={password} onChange={hanldePasswordChange} />
</label>

  </div>
  {errMessage && <p className="text-red-400 mt-3">{errMessage}</p>}
    <div className="card-actions justify-center mt-3">
      <button className="btn btn-primary" onClick={hanldeLoginClick}>Sign up</button>
    </div>
  </div>
</div>
    </div>
